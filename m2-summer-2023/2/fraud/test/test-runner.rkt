...
(define (test-runner run)
  ...
  ;; Overflow examples
  (check-equal? (run '(add1 +4611686018427387903)) 'err)
  (check-equal? (run '(sub1 -4611686018427387904)) 'err)
  (check-equal? (run '(add1 (sub1 +4611686018427387903))) +4611686018427387903)
  (check-equal? (run '(sub1 (add1 -4611686018427387904))) -4611686018427387904)   
  (check-equal? (run '(sub1 (add1 +4611686018427387903))) 'err)
  (check-equal? (run '(add1 (sub1 -4611686018427387904))) 'err)

  (check-equal? (run '(+ +4611686018427387903 1)) 'err)
  (check-equal? (run '(- -4611686018427387904 1)) 'err)
  (check-equal? (run '(+ (- +4611686018427387903 1) 1)) +4611686018427387903)
  (check-equal? (run '(- (+ -4611686018427387904 1) 1)) -4611686018427387904)   
  (check-equal? (run '(- (+ +4611686018427387903 1) 1)) 'err)
  (check-equal? (run '(+ (- -4611686018427387904 1) 1)) 'err)
